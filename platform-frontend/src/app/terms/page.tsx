      ...
      <div className="prose max-w-none space-y-8">
        <section>
          ...
          <p className="text-gray-600 leading-relaxed">
            By accessing and using {config.name}&apos;s online store, you agree
        ...
        <section>
          ...
          <p className="text-gray-600 leading-relaxed">
            All products displayed on our store are subject to availability. We
            reserve the right to modify prices, descriptions, and availability
        ...
        <section>
          ...
          <p className="text-gray-600 leading-relaxed">
            Orders are confirmed after payment verification. We reserve the
            right to cancel any order if there is an error in pricing, product
            description, or if the product is out of stock. You will be notified
            via WhatsApp or email if your order is cancelled.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-gray-600 leading-relaxed">
            Payment must be completed before your order is processed. We accept
            bank transfers and other payment methods as displayed at checkout.
            Prices are in {config.settings.currency}.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-gray-600 leading-relaxed">
            Shipping costs are calculated based on your location and will be
            communicated before dispatch. Delivery times are estimates and may
            vary. We are not responsible for delays caused by the shipping
            carrier.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-gray-600 leading-relaxed">
            ...
            Products must be in their original condition with all tags attached.
        ...
        <section>
          ...
          <p className="text-gray-600 leading-relaxed">
            Your personal information is collected solely for processing orders
            and improving our services. We do not sell or share your data with
