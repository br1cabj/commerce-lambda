        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
            ...
            <div className="space-y-3 text-sm text-gray-400">
              {config.settings.email && (
                <p className="flex items-center gap-3 hover:text-white transition-colors">
                  ...
                  <span className="break-all">{config.settings.email}</span>
                </p>
              )}
              ...
              {config.settings.shippingMethods.length > 0 && (
                <p className="flex items-center gap-3">
                  <Truck className="h-4 w-4 flex-shrink-0" style={{ color: config.theme.accentColor }} />
          ...
          <div>
            ...
            <div className="grid grid-cols-3 gap-2">
              {["Visa", "MasterCard", "PayPal", "Apple Pay", "Google Pay", "Stripe"].map((method) => (
                <div
                  key={method}
                  className="bg-gray-800 rounded-lg px-3 py-2 text-center text-xs font-medium text-gray-400"
                >
                  {method}
                </div>
              ))}
