  ...
  try {
    ...
    res.json({
      ...
      settings: {
        ...
        shippingMethods: tenant.settings.shippingMethods.filter(
          (m) => m.enabled,
        ),
  ...
  try {
    ...
    if (theme) {
      ...
      if (theme.secondaryColor)
        tenant.theme.secondaryColor = theme.secondaryColor;
      ...
      if (theme.heroImageUrl !== undefined)
        tenant.theme.heroImageUrl = theme.heroImageUrl;
      if (theme.heroTitle !== undefined)
        tenant.theme.heroTitle = theme.heroTitle;
      if (theme.heroSubtitle !== undefined)
        tenant.theme.heroSubtitle = theme.heroSubtitle;
