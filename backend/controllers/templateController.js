...
const templates = {
  fashion: {
    ...
    theme: {
      ...
      accentColor: "#e91e63",
      heroTitle: { en: "New Season Collection", es: "Nueva Colección de Temporada" },
      heroSubtitle: { en: "Discover the latest trends in fashion", es: "Descubre las últimas tendencias en moda" },
    },
    translations: {
      hero: {
      ...
      featured: {
        ...
        subtitle: { en: "Most popular items this season", es: "Artículos más populares esta temporada" },
        viewAll: { en: "View All", es: "Ver Todo" },
      },
      categories: {
        title: { en: "Shop by Category", es: "Comprar por Categoría" },
        subtitle: { en: "Find your perfect style", es: "Encuentra tu estilo perfecto" },
      },
      trustSignals: {
        freeShipping: { en: "Free Shipping", es: "Envío Gratis" },
        freeShippingDesc: { en: "On orders over $75", es: "En pedidos mayores a $75" },
        ...
        supportDesc: { en: "Personal styling advice", es: "Consejos de estilo personal" },
      },
    },
    heroSlides: [
      {
  ...
  electronics: {
    ...
    theme: {
      ...
      heroSubtitle: { en: "Innovation at your fingertips", es: "Innovación al alcance de tu mano" },
    },
    translations: {
      hero: {
      ...
      featured: {
        ...
        subtitle: { en: "Top-rated electronics and gadgets", es: "Electrónica y gadgets mejor valorados" },
        viewAll: { en: "View All", es: "Ver Todo" },
      },
      categories: {
        title: { en: "Shop by Category", es: "Comprar por Categoría" },
        subtitle: { en: "Find the perfect tech for you", es: "Encuentra la tecnología perfecta para ti" },
      },
      trustSignals: {
        freeShipping: { en: "Free Shipping", es: "Envío Gratis" },
        freeShippingDesc: { en: "On orders over $100", es: "En pedidos mayores a $100" },
        securePayment: { en: "Secure Payment", es: "Pago Seguro" },
        securePaymentDesc: { en: "256-bit SSL encryption", es: "Encriptación SSL de 256 bits" },
        easyReturns: { en: "30-Day Returns", es: "Devoluciones en 30 Días" },
        easyReturnsDesc: { en: "Hassle-free returns", es: "Devoluciones sin complicaciones" },
        support: { en: "24/7 Tech Support", es: "Soporte Técnico 24/7" },
        supportDesc: { en: "Expert help anytime", es: "Ayuda experta en cualquier momento" },
      },
    },
    heroSlides: [
      {
        title: { en: "New Smartphones", es: "Nuevos Smartphones" },
        subtitle: { en: "Latest models with cutting-edge features", es: "Últimos modelos con características de vanguardia" },
      ...
      },
      {
        ...
        subtitle: { en: "Level up your gaming experience", es: "Mejora tu experiencia de juego" },
  ...
  food: {
    ...
    theme: {
      ...
      heroSubtitle: { en: "Fresh ingredients, amazing flavors", es: "Ingredientes frescos, sabores increíbles" },
    },
    translations: {
      hero: {
      ...
      featured: {
        ...
        subtitle: { en: "Customer favorites this week", es: "Favoritos de clientes esta semana" },
        viewAll: { en: "View Menu", es: "Ver Menú" },
      },
      categories: {
        title: { en: "Browse Categories", es: "Explorar Categorías" },
        subtitle: { en: "Something for every taste", es: "Algo para cada gusto" },
      },
      trustSignals: {
        freeShipping: { en: "Free Delivery", es: "Entrega Gratis" },
        freeShippingDesc: { en: "On orders over $30", es: "En pedidos mayores a $30" },
        securePayment: { en: "Secure Checkout", es: "Pago Seguro" },
        securePaymentDesc: { en: "Safe & encrypted", es: "Seguro y encriptado" },
        easyReturns: { en: "Quality Guarantee", es: "Garantía de Calidad" },
        easyReturnsDesc: { en: "Freshness guaranteed", es: "Frescura garantizada" },
    ...
    heroSlides: [
      {
        ...
        subtitle: { en: "Farm-to-table quality ingredients", es: "Ingredientes de calidad del campo a la mesa" },
      ...
      },
      {
        ...
        subtitle: { en: "Save on your favorites", es: "Ahorra en tus favoritos" },
        ctaPrimary: { en: "See Deals", es: "Ver Ofertas" },
        ctaSecondary: { en: "Shop All", es: "Comprar Todo" },
      },
    ],
    categories: ["Fresh Produce", "Beverages", "Snacks", "Organic", "Specialty"],
  },
  ...
  beauty: {
    ...
    theme: {
      ...
      heroSubtitle: { en: "Premium beauty products for your best self", es: "Productos de belleza premium para tu mejor versión" },
    },
    translations: {
      hero: {
      ...
      categories: {
        title: { en: "Shop by Category", es: "Comprar por Categoría" },
        subtitle: { en: "Your beauty essentials", es: "Tus esenciales de belleza" },
      },
      trustSignals: {
        freeShipping: { en: "Free Shipping", es: "Envío Gratis" },
        ...
        securePayment: { en: "Secure Payment", es: "Pago Seguro" },
        securePaymentDesc: { en: "100% protected", es: "100% protegido" },
        easyReturns: { en: "Satisfaction Guarantee", es: "Garantía de Satisfacción" },
        easyReturnsDesc: { en: "Love it or return it", es: "Ámalo o devuélvelo" },
        support: { en: "Beauty Advisors", es: "Asesores de Belleza" },
        supportDesc: { en: "Expert advice available", es: "Consejos expertos disponibles" },
      },
    },
    heroSlides: [
      {
        title: { en: "New Arrivals", es: "Nuevos Ingresos" },
        subtitle: { en: "Latest beauty innovations", es: "Últimas innovaciones en belleza" },
        ctaPrimary: { en: "Shop New", es: "Comprar Nuevo" },
        ctaSecondary: { en: "View Lookbook", es: "Ver Lookbook" },
      },
      {
        title: { en: "Skincare Essentials", es: "Esenciales de Skincare" },
        subtitle: { en: "Your daily routine perfected", es: "Tu rutina diaria perfeccionada" },
  ...
  sports: {
    ...
    theme: {
      ...
      heroSubtitle: { en: "Performance gear for every athlete", es: "Equipo de rendimiento para cada atleta" },
    },
    translations: {
      hero: {
        shopNow: { en: "Shop Now", es: "Comprar Ahora" },
      ...
      featured: {
        ...
        subtitle: { en: "Athlete-approved equipment", es: "Equipo aprobado por atletas" },
        viewAll: { en: "View All", es: "Ver Todo" },
      },
      categories: {
        title: { en: "Shop by Sport", es: "Comprar por Deporte" },
        subtitle: { en: "Find your sport's essentials", es: "Encuentra los esenciales de tu deporte" },
      },
      trustSignals: {
        freeShipping: { en: "Free Shipping", es: "Envío Gratis" },
        freeShippingDesc: { en: "On orders over $75", es: "En pedidos mayores a $75" },
    ...
    heroSlides: [
      {
        ...
        subtitle: { en: "Everything you need to hit the road", es: "Todo lo que necesitas para salir a correr" },
      ...
      },
      {
        ...
        subtitle: { en: "Build your perfect workout", es: "Construye tu entrenamiento perfecto" },
  ...
  home: {
    ...
    theme: {
      ...
      heroSubtitle: { en: "Transform your space with style", es: "Transforma tu espacio con estilo" },
    },
    translations: {
      hero: {
      ...
      featured: {
        ...
        subtitle: { en: "Curated for your home", es: "Seleccionados para tu hogar" },
        viewAll: { en: "View All", es: "Ver Todo" },
      },
      categories: {
        title: { en: "Shop by Room", es: "Comprar por Habitación" },
        subtitle: { en: "Find what you need", es: "Encuentra lo que necesitas" },
      },
      trustSignals: {
        freeShipping: { en: "Free Shipping", es: "Envío Gratis" },
        freeShippingDesc: { en: "On orders over $100", es: "En pedidos mayores a $100" },
    ...
    heroSlides: [
      {
        ...
        subtitle: { en: "Cozy essentials for gathering", es: "Esenciales acogedores para reunirse" },
  ...
  books: {
    ...
    theme: {
      ...
      accentColor: "#ff6f00",
      heroTitle: { en: "Discover Your Next Read", es: "Descubre Tu Próxima Lectura" },
      heroSubtitle: { en: "Thousands of titles, endless stories", es: "Miles de títulos, historias infinitas" },
    },
    translations: {
      hero: {
      ...
      featured: {
        title: { en: "Bestsellers", es: "Más Vendidos" },
        subtitle: { en: "What everyone's reading", es: "Lo que todos están leyendo" },
        viewAll: { en: "View All", es: "Ver Todo" },
      },
      categories: {
        title: { en: "Browse by Genre", es: "Explorar por Género" },
        subtitle: { en: "Find your next favorite", es: "Encuentra tu próximo favorito" },
      },
      trustSignals: {
        freeShipping: { en: "Free Shipping", es: "Envío Gratis" },
        freeShippingDesc: { en: "On orders over $25", es: "En pedidos mayores a $25" },
        securePayment: { en: "Secure Payment", es: "Pago Seguro" },
        securePaymentDesc: { en: "100% protected", es: "100% protegido" },
        easyReturns: { en: "Easy Returns", es: "Devoluciones Fáciles" },
        easyReturnsDesc: { en: "30-day return policy", es: "Política de 30 días" },
        support: { en: "Book Recommendations", es: "Recomendaciones de Libros" },
        supportDesc: { en: "Personalized suggestions", es: "Sugerencias personalizadas" },
      },
    },
    heroSlides: [
      {
        title: { en: "New Releases", es: "Nuevos Lanzamientos" },
        subtitle: { en: "Fresh off the press", es: "Recién salidos de la imprenta" },
        ctaPrimary: { en: "Shop New", es: "Comprar Nuevo" },
        ctaSecondary: { en: "View Pre-orders", es: "Ver Pre-ventas" },
      },
      {
        title: { en: "Staff Picks", es: "Selecciones del Personal" },
        subtitle: { en: "Our favorites this month", es: "Nuestros favoritos este mes" },
        ctaPrimary: { en: "See Picks", es: "Ver Selecciones" },
        ctaSecondary: { en: "Read Reviews", es: "Leer Reseñas" },
      },
    ],
    categories: ["Fiction", "Non-Fiction", "Children", "Education", "Audiobooks"],
  },
  ...
  toys: {
    ...
    theme: {
      ...
      heroSubtitle: { en: "Toys that inspire imagination", es: "Juguetes que inspiran imaginación" },
    },
    translations: {
      hero: {
      ...
      featured: {
        ...
        subtitle: { en: "Kids' favorites right now", es: "Favoritos de los niños ahora" },
        viewAll: { en: "View All", es: "Ver Todo" },
      },
      categories: {
        title: { en: "Shop by Age", es: "Comprar por Edad" },
        subtitle: { en: "Perfect toys for every age", es: "Juguetes perfectos para cada edad" },
      },
      trustSignals: {
        freeShipping: { en: "Free Shipping", es: "Envío Gratis" },
        freeShippingDesc: { en: "On orders over $50", es: "En pedidos mayores a $50" },
        ...
        supportDesc: { en: "Free with every order", es: "Gratis en cada pedido" },
      },
    },
    heroSlides: [
      {
        title: { en: "New Arrivals", es: "Nuevos Ingresos" },
        subtitle: { en: "Exciting new toys just in", es: "Emocionantes juguetes nuevos" },
        ctaPrimary: { en: "Shop New", es: "Comprar Nuevo" },
        ctaSecondary: { en: "See All", es: "Ver Todo" },
      },
      {
        title: { en: "Educational Toys", es: "Juguetes Educativos" },
        subtitle: { en: "Learn while having fun", es: "Aprende mientras te diviertes" },
